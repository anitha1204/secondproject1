      ...
      <div className="overflow">
        <section className="w-full h-screen relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white bg-black bg-opacity-60">
            ...
            <button className="absolute top-14 right-10 lg:mr-20 bg-green-600 text-white py-2 px-4 rounded-lg">
              Quick Chat
            </button>
            <div className="mt-16 text-center md:text-left md:mr-[795px] mg:mr-20">
          ...
          <div className="hidden md:flex absolute w-full translate-y-[-150px] justify-around px-4">
            <div className="flex flex-col md:flex-row md:items-center w-full md:w-1/2 text-center md:text-left px-4 md:px-10 lg:px-20">
              <div className="flex flex-col md:ml-4 mb-60">
                ...
                <div className="flex flex-row justify-center md:justify-start space-x-4 md:mb-0 mr-[70px]">
                  <HiOutlineArrowCircleLeft
                    size={40}
                ...
                <Link to="">
                <button className=" bg-green-600 text-white py-3 px-6 rounded-lg mb-7 ml-[-190px]">
                   Brochure Download
              </button>
              </Link>
            </div>
          ...
          <div className="md:hidden w-full">
            ...
            <Link to="">
            <button className=" bg-green-600 text-white py-2 px-4 rounded-lg ml-[90px] mt-6">
                 Brochure Download
            </button>
            </Link>
            <div className="relative flex items-center">
              ...
              <div className="flex overflow-hidden w-full mt-6 ml-14">
                <img
                  ...
                  className="w-64 h-80 object-cover rounded-2xl mt-2"
                />
              </div>
              <button
                onClick={handleNext}
        ...
        <div className="container mx-auto text-center">
          ...
          <div className="mb-6">
            <Link to="/" onClick={() => window.scrollTo(0, 0)}>
              <img
                src={companyLogo}
                alt="Company Logo"
                className="mx-auto h-30 w-40 cursor-pointer"
              />
            </Link>
          </div>
          <div className="flex flex-col md:flex-row justify-center items-center space-y-2 md:space-y-0 md:space-x-6 text-sm">
            ...
            <div className="flex items-center">
              ...
              <span>
                1C/609, 1st floor, Lakshmi Bhavan, Anna Salai, Chennai 006.
              </span>
            </div>
          </div>
        </div>
